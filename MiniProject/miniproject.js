...
function randomColor() {
    var colors = [
        '#34495e','#6C7A89','#ABB7B7','#336E7B','#8E44AD','#674172','#D2527F','#96281B','#34495e','#16a085','#f39c12',
        '#d35400','#c0392b','#7f8c8d','#8e44ad'];
...
$("#newQuote").click(function () {
    $('body').css({'background': randomColor(), 'transition': 'all linear 0.1s'});
    randomQuote();
});